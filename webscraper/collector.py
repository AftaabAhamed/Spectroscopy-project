...
with open(r'C:\Users\aftaa\Desktop\alcohol-ID.txt', 'r') as f:
    while True:
        line = f.readline()
        if not line:
            break        
...
def download_image(filename,count):
    ...
    pic_path = r"D:\programlanguages\python-\vspython\spectroscopy-project\sbds-data-collect-raw\alcohols"
    crop_pic_path = r"D:\programlanguages\python-\vspython\spectroscopy-project\sbds-data-collect-raw\alcohol_crop"
...
for ids in sdbs_ids:
    ...
    try:
        no_of_graph = download_image(file_name,no_of_graphs)
